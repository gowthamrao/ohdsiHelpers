...
CreateTable1FromCovariateData <- function(covariateData1,
  ...
  covariateData1 <-
    checkFilterTemporalCovariateDataByTimeIdCohortId(covariateData = covariateData1,
                                                     cohortId = cohortId1,
                                                     timeId = timeId1)
  ...
  if (!is.null(covariateData2)) {
    covariateData2 <-
      checkFilterTemporalCovariateDataByTimeIdCohortId(covariateData = covariateData2,
                                                       cohortId = cohortId2,
                                                       timeId = timeId2)
